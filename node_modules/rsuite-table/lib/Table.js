...
function (_React$Component) {
    ...
    React.Children.forEach(columns, function (column, index) {
      if (React.isValidElement(column)) {
        ...
        if (showHeader && headerHeight) {
          ...
          headerCells.push(React.cloneElement(columnChildren[0], (0, _extends2["default"])({}, cellProps, {}, headerCellProps)));
        }
  ...
  _proto.renderRow = function renderRow(props, cells, shouldRenderExpandedRow, rowData) {
    ...
    if (shouldFixedColumn && contentWidth > width) {
      ...
      return React.createElement(_Row["default"], (0, _extends2["default"])({}, props, {
        style: rowStyles
      }), fixedLeftCellGroupWidth ? React.createElement(_CellGroup["default"], {
        fixed: "left",
      ...
      }, (0, _utils.colSpanCells)((0, _utils.resetLeftForCells)(fixedLeftCells))) : null, React.createElement(_CellGroup["default"], null, (0, _utils.colSpanCells)(scrollCells)), fixedRightCellGroupWidth ? React.createElement(_CellGroup["default"], {
        fixed: "right",
        style: this.isRTL() ? {
    ...
    return React.createElement(_Row["default"], (0, _extends2["default"])({}, props, {
      style: rowStyles
    }), React.createElement(_CellGroup["default"], null, (0, _utils.colSpanCells)(cells)), shouldRenderExpandedRow && this.renderRowExpanded(rowData));
  };
  ...
  _proto.renderTableBody = function renderTableBody(bodyCells, rowWidth) {
    ...
    }, topHideHeight ? React.createElement(_Row["default"], {
      style: topRowStyles,
      className: "virtualized"
    }) : null, this._visibleRows, bottomHideHeight ? React.createElement(_Row["default"], {
